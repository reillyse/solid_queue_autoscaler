...
require_relative 'lib/solid_queue_heroku_autoscaler/version'

Gem::Specification.new do |spec|
  spec.name = 'solid_queue_heroku_autoscaler'
  spec.version = SolidQueueHerokuAutoscaler::VERSION
  ...
  spec.homepage = 'https://github.com/reillyse/solid_queue_heroku_autoscaler'
  spec.license = 'MIT'
